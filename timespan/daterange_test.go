...
// var d0320 = dateold.New(2015, time.March, 20)
// var d0321 = dateold.New(2015, time.March, 21)
// var d0325 = dateold.New(2015, time.March, 25)
// var d0326 = dateold.New(2015, time.March, 26)
// var d0327 = dateold.New(2015, time.March, 27)
// var d0328 = dateold.New(2015, time.March, 28)
// var d0329 = dateold.New(2015, time.March, 29) // n.b. clocks go forward (UK)
// var d0330 = dateold.New(2015, time.March, 30)
// var d0331 = dateold.New(2015, time.March, 31)
// var d0401 = dateold.New(2015, time.April, 1)
// var d0402 = dateold.New(2015, time.April, 2)
// var d0403 = dateold.New(2015, time.April, 3)
// var d0404 = dateold.New(2015, time.April, 4)
// var d0407 = dateold.New(2015, time.April, 7)
// var d0408 = dateold.New(2015, time.April, 8)
// var d0409 = dateold.New(2015, time.April, 9)
// var d0410 = dateold.New(2015, time.April, 10)
// var d0501 = dateold.New(2015, time.May, 1)
// var d1025 = dateold.New(2015, time.October, 25)
...
// 	isEq(t, 0, dr.Days(), dateold.PeriodOfDays(7))
...
// 	isEq(t, 0, dr2.Days(), dateold.PeriodOfDays(7))
...
// 	isEq(t, 0, drN0.Days(), dateold.PeriodOfDays(1))
...
// 	isEq(t, 0, dr2.Days(), dateold.PeriodOfDays(2))
...
// 	isEq(t, 0, dr3.Days(), dateold.PeriodOfDays(2))
// 	isEq(t, 0, dr3.String(), "2 days from 2015-03-25 to 2015-03-26")
// }

// func TestNewYearOf(t *testing.T) {
// 	dr := NewYearOf(2015)
// 	isEq(t, 0, dr.Days(), dateold.PeriodOfDays(365))
// 	isEq(t, 0, dr.Start(), dateold.New(2015, time.January, 1))
// 	isEq(t, 0, dr.Last(), dateold.New(2015, time.December, 31))
// 	isEq(t, 0, dr.End(), dateold.New(2016, time.January, 1))
// }

// func TestNewMonthOf(t *testing.T) {
// 	dr := NewMonthOf(2015, time.February)
// 	isEq(t, 0, dr.Days(), dateold.PeriodOfDays(28))
// 	isEq(t, 0, dr.Start(), dateold.New(2015, time.February, 1))
// 	isEq(t, 0, dr.Last(), dateold.New(2015, time.February, 28))
// 	isEq(t, 0, dr.End(), dateold.New(2015, time.March, 1))
// }

// func TestShiftAndExtend(t *testing.T) {
// 	cases := []struct {
// 		dr    DateRange
// 		n     dateold.PeriodOfDays
// 		start dateold.Date
// 		end   dateold.Date
// 		s     string
// 	}{
